            ...
            },
            {
                ...
                new KillstreakRewardTable
                {
                    ...
                    PlayerTable = new SortedDictionary<int, List<PlayerReward>>
                    {
                        ...
                        {8, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 20 } } },
                        {9, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 20 } } },
                        {10, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 0, Value = 10 } } },
                        {11, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 1, Value = 10 } } },
                        ...
                        {14, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 4, Value = 10 } } },
                        {15, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 5, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        ...
                        {18, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 8, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        {19, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 9, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        ...
                        {22, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 12, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
                        {23, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 13, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
                        {24, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Sustain = 14, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
            ...
            },
            {
                ...
                new KillstreakRewardTable
                {
                    ...
                    PlayerTable = new SortedDictionary<int, List<PlayerReward>>
                    {
                        ...
                        {8, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 20 } } },
                        {9, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 20 } } },
                        {10, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 10 } } },
                        {11, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 10 } } },
                        {12, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 10 } } },
                        {13, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 10 } } },
                        {14, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 40 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 10 } } },
                        {15, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        {16, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        {17, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        {18, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        {19, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 60 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 20 }, new PlayerReward {Stat = PlayerStat.HP, Value = 15} } },
                        {20, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
                        {21, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
                        {22, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
                        {23, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
                        {24, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 80 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 30 }, new PlayerReward {Stat = PlayerStat.HP, Value = 30} } },
                        {25, new List<PlayerReward>{ new PlayerReward {Stat = PlayerStat.Stamina, Value = 100 }, new PlayerReward {Stat = PlayerStat.AHP, Persistent = true, Value = 40 }, new PlayerReward {Stat = PlayerStat.HP, Value = 45} } },
                    },
